...
export default function CategoryChip({ label }: CategoryChipProps) {
  ...
  return (
    <div className="inline-flex items-center justify-center px-4 py-2 rounded-full border border-gray-300 bg-gray-100 text-gray-800 font-bold text-sm whitespace-nowrap">
      {label}
    </div>
  );
}